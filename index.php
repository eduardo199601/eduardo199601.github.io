                    ...
                    <section class="portfolio-item border border-5 shadow p-3 mb-3  rounded w-75 mx-auto">
                        <section class="row">
                            <section class="p-3 text-center">
                                <h5>Hola, soy Angel E. Martin</h5>
                                <p class="pt-3">Soy un estudiante de primer año de programación universitaria con una pasión por el desarrollo web.
                                Poseo habilidades sólidas en diversas tecnologías clave para la creación de sitios web dinámicos y funcionales.
                                Mi enfoque se centra en garantizar una experiencia de usuario excepcional a través de un diseño atractivo y un código limpio.</p>
                            </section>
                        </section>
                    </section>
                </section>
...
<!habilidades y contacto !>
    ...
    <section class="container">
        <section class="justify-content-between">
                <section class="portfolio-item border border-5 shadow p-3 mb-3 bg-body rounded">
                    <section class="p-3">
                        <h5>Conocimentos en:</h5>
                    </section>
                    <section class="container">
